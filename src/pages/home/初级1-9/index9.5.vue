...
const initRender = () => {
  ...
  const pointsArr = curve.getPoints(50); // 分段数50，返回51个顶点
  ...
  const arr2 = [new THREE.Vector2(-100, 0), new THREE.Vector2(0, 30), new THREE.Vector2(100, 0)];
  // 二维样条曲线
  const geometry3 = new THREE.BufferGeometry();
  const curve2 = new THREE.SplineCurve(arr2);
  const pointsArr2 = curve2.getPoints(50);
