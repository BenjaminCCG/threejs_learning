<template>
  ...
  <div id="card" class="flex items-center text-light-50 invisible absolute backface-hidden">
    <div class="w-20 h-1 bg-black"></div>
    <div class="w-20 text-center h-10 border-1">card</div>
    <div id="close" class="cursor-pointer">xxx</div>
  </div>
</template>
